...
export class CreateTasks1780934074845 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_e08fca67ca8966e6b9914bf295" ON "tasks"  ("projectId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_34701b0b8d466af308ba202e4e" ON "tasks"  ("parentTaskId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD CONSTRAINT "FK_660898d912c6e71107e9ef8f38d" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" DROP CONSTRAINT "FK_34701b0b8d466af308ba202e4ef"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_34701b0b8d466af308ba202e4e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e08fca67ca8966e6b9914bf295"`,
    );
