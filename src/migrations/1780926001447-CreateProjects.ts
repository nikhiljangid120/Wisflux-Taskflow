...
export class CreateProjects1780926001447 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_108ff8a2d40c2b294511c92a7c" ON "projects"  ("workspaceId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f55144dc92df43cd1dad5d29b9" ON "projects"  ("createdById") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "projects" ADD CONSTRAINT "FK_f55144dc92df43cd1dad5d29b90" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f55144dc92df43cd1dad5d29b9"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_108ff8a2d40c2b294511c92a7c"`,
    );
